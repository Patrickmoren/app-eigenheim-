...
| Besichtigung organisieren | ja (Terminlogik) | ja | **physische Durchführung braucht einen Menschen** (Eigentümer:in, Hauswart oder Partner vor Ort) | niedrig | niedrig | KI koordiniert, Mensch/Partner führt durch (oder Selbstbesichtigung mit Schliessfach-Lösung — Zukunftsoption) |
...
|---|---|---|---|
| Besichtigungen (physische Durchführung) | **Nein** | Braucht physische Präsenz vor Ort | (a) Eigentümer:in führt selbst durch (Standard bei Vollautonomie "tief"), (b) regionales Partnernetz von Hauswart:innen/freien Besichtigungspartnern auf Provisionsbasis, (c) langfristig Self-Service-Besichtigung mit smartem Schliessfach (Investition, nicht am Anfang) |
...
**Fazit:** Mietpilot kann *nicht* vollständig ohne proportionalen Personalaufbau skalieren — die Unit-Economics-Tabelle in Phase 8 zeigt das explizit (Personal steigt von 1 auf 40–55 FTE bei 50'000 Fällen). Das ist **kein Automatisierungsversagen**, sondern eine reale Grenze physischer Prozessschritte (Besichtigung, Übergabe, Eskalation). Das ist trotzdem deutlich besser als ein klassisches Maklerunternehmen (bei dem Personal linear mit dem Fallvolumen mitwachsen würde) — aber es ist **keine reine "Software-Skalierung"**, wie der Ausgangswunsch (1'000× mehr Fälle ohne 1'000× mehr Personal) es suggeriert. Modell 4/G (B2B2C-Engine) löst genau dieses Problem, weil Besichtigung/Übergabe/lokaler Support dann beim Partner liegen, nicht bei Mietpilot selbst.
