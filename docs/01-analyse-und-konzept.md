...
| **2 Abnahme & Vermarktung** (Sollfristen: Abnahmetermin 30 Tage vor Wohnungsabgabe, Handwerkeraufgebot 3 Tage nach der Abnahme) | L–V | WA durchgeführt + Zustimmungserklärung + Instandstellung beauftragt |
...
| niemand erinnert an die Vorbereitung der Abnahme | **Sollfristen mit eigenem Anker**: «Abnahmetermin vereinbaren» wird 30 Tage vor der Wohnungsabgabe fällig (Anker Haftungsdatum), «Handwerker aufbieten» 3 Tage nach der durchgeführten Abnahme (Anker Abnahmedatum) – vorher ist nicht bekannt, was zu beauftragen ist |
...
| Vorbereitung der Abnahme nur aus dem Gedächtnis | Sollfristen, automatisch aus Haftungsdatum bzw. Abnahmedatum | Termin steht rechtzeitig, Handwerker werden unmittelbar nach der Abnahme beauftragt |
